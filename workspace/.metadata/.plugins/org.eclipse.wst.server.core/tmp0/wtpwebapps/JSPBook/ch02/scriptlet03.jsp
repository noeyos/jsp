...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/sbadmin2/index.html">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/sbadmin2/cards.html">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/sbadmin2/tables.html">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        case(5):
                                        case(9): 
                                        	out.print("<i class='fas fa-calendar fa-2x text-gray-300'></i>");
                                     		break;
                                     	case(2):
                                     	case(6):
                                     	case(10):
                                            out.print("<i class='fas fa-dollar-sign fa-2x text-gray-300'></i>");
                                            break;
                                     	case(3):
                                     	case(7):
                                        	out.print("<i class='fas fa-clipboard-list fa-2x text-gray-300'></i>");
                                     		break;
                                     	case(4):
                                     	case(8):
                                     		out.print("<i class='fas fa-comments fa-2x text-gray-300'></i>");
                                 			break;
                                         } %>
...
<%--           (( 쌤 방법 ))             <%
                                         String cls = "";
                                         if(i%4==1) {
                                        	 cls = "fa-calendear fa-2x";
                                         } else if (i%4==2) {
                                        	 cls = "fa-dollar-sign fa-2x"; 
                                         } else if (i%4==3) {
                                        	 cls = "fa-clipboard-list fa-2x";
                                         } else {
											cls = "fa-comments fa-2x";                                        	 
                                         }
                                         %>
                                         <i class="fas <%= cls %>    text gray-300"></i>    --%>
