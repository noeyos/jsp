 ...
 * Generated at: 2023-07-05 02:44:01 UTC
...
public final class validation04_005f2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		<!-- checkform(): 핸들러함수   -->\r\n");
      out.write("		<p><input type=\"button\" value=\"전송\" onclick=\"checkForm();\"></p>\r\n");
      out.write("	</form>\r\n");
      out.write("<script>\r\n");
      out.write("	function checkForm() {\r\n");
      out.write("		let form = document.loginForm;\r\n");
      out.write("		// 1) 아이디는 영문 소문자만 입력 가능\r\n");
      out.write("		// form.id.value : admin (legnth:5)\r\n");
      out.write("		for(i=0; i<form.id.value.length; i++) {\r\n");
      out.write("			let ch = form.id.value.charAt(i); //a(0)->d(1)->m(2)->i(3)->n(4)\r\n");
      out.write("			// 영문 소문자가 아닌 경우\r\n");
      out.write("			if((ch<'a'||ch>'z') && (ch>='A'||ch<='Z') && (ch>='0'||ch<='9')) { \r\n");
      out.write("				alert(\"아이디는 영문 소문자만 입력 가능합니다.\")\r\n");
      out.write("				form.id.select();\r\n");
      out.write("				return;	 // 함수 멈춤\r\n");
      out.write("				// break -> for문 멈춤 (for문 다음으로 오는 코드 실행함)\r\n");
      out.write("				// return -> 함수 자체를 멈춤 (for문 다음으로 오는 코드 실행안함)\r\n");
      out.write("			} // end for\r\n");
      out.write("			// 2) 비밀번호는 숫자만 입력 가능\r\n");
      out.write("			// 이것은 숫자가 아니다(isNaN)\r\n");
      out.write("			if(isNaN(form.passwd.value)) {\r\n");
      out.write("				alert(\"비밀번호는 숫자만 입력 가능합니다.\");\r\n");
      out.write("				form.passwd.select();\r\n");
      out.write("				return; //함수 멈춤\r\n");
      out.write("			}\r\n");
      out.write("			// 아이디 및 비밀번호 유효성검사(validation)를 통과시\r\n");
      out.write("			form.submit(); // 폼 페이지에 입력된 데이터 값을 서버로 전송(request객체에 담아서)\r\n");
      out.write("			\r\n");
      out.write("		}\r\n");
      out.write("		// 2) 비밀번호는 숫자만 입력 가능\r\n");
      out.write("	}\r\n");
