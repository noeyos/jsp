...
// VO : Value Object / DTO : Data Trasport Object
...
public class UsersVO {
	...
	// 동일 클래스에서 같은 이름의 메소드를 사용
	// ==> 오버로딩(파라미터의 개수, 파라미터의 타입)
	...
	//010,1111,2222 파라미터를 받아서 010-1111-2222를 phone 멤버변수에 setting 해주는 메소드
