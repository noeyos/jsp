...
<body>
	<h3>회원가입</h3>
	<!-- 폼태그, 폼필드
	action생략 시 본인 페이지를 요청
	method 생략 시 기본 HTTP요청방식은 get
	-->
	<!-- 요청URL : form01_process.jsp
		요청방식 : post
		요청파라미터(HTTP파라미터 = QueryString) :
			{id=a001, passwd=java, name=개똥이, phone=010-1234-1234, id="hobby1"
	...
	<form action="form01_process.jsp" name="member" method="post" onsubmit="return fn_chk()">
 		...
 		<p>
 			<!-- rows : 줄수 / cols : 열수
 			wrap="off" : 줄바꿈 안 함, "soft" : 자동 줄 바꿈,
 			"hard" : 서버전송 시 캐리지 리턴 문자를 전달
 			-->
